...
//category table
router.get('/show-category-form',adminController.userAuth, adminController.showCategoryForm)
router.get('/show-category-table',adminController.userAuth, adminController.showCategoryTable)
router.post('/post-category-form',adminController.userAuth, adminController.postCategoryForm)


router.get("/posts", adminController.userAuth, adminController.posts);
router.get("/activepost/(:id)", adminController.userAuth, adminController.activePost);
router.get("/deactivepost/(:id)", adminController.userAuth, adminController.deActivePost);


router.get("/users", adminController.userAuth, adminController.frontEndUsers);
router.get("/activeusers/(:id)", adminController.userAuth, adminController.activeFrontUser);
router.get("/users/(:id)", adminController.userAuth, adminController.deactiveFrontUser);

router.get("/comment", adminController.userAuth, adminController.comments);
router.get("/activecomment/(:id)", adminController.userAuth, adminController.activeComment);
router.get("/deactivecomment/(:id)", adminController.userAuth, adminController.deActiveComment);
